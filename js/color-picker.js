...
if('undefined' == typeof window.oneClickScreenshotColorPickerListenerInstalled){
	...
	var divCover  = document.createElement('div');
		...
		chrome.runtime.onMessage.addListener(function(message){
			console.log(message)
			switch(message.data){
				case 'addColorpickerCss':
					var exsits = document.getElementById('colorpickerCss');
					if(!exsits){
						var head  = document.getElementsByTagName('head')[0],
					    	link  = document.createElement('link');
				    	link.id   = 'colorpickerCss';
				    	link.rel  = 'stylesheet';
				    	link.type = 'text/css';
				    	link.href = message.cssUrl
				    	link.media = 'all';
				...
				case 'ctx':
		          ...
		          image.onload = function() {
		           ...
		           // console.log(yConverted,xConverted);
		           	...
		           	console.log(show,example, rgbData, rgba.innerText, rgbData, message.sizes.x, message.sizes.y, message);
...
window.oneClickScreenshotColorPickerListenerInstalled = 1;